...
var numberOfFloorsBurjKhalifa = 2;
...
var japanPrefectures = ["Osaka", "Kyoto","Hokkaido", "Tokyo", "Japan"];
...
Console log the variable.*/
var india = ["Indian Place", "Indian Place", "Indian Place"];
console.log(india);
...
var difference = subtract(cat,dog);
...
function dunkinDonuts(num){
  return "I eat " + num + " old fashioned donuts every morning to stay classy";
}
...
function stayinClassy(diff, prod){
  return "Yea, I drank " + diff + " gallons of box wine and ate " + prod + " bags of Cheetos and still feel vibrant yo!";
}
...
var drinkinAlready = oldEnough(20);
...
console.log(firstReverse("Yeaaaa Boiiii"));
